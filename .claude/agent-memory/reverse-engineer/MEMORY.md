...
- [Drol entity-slot tick+draw pattern](drol-entity-slot-pattern.md) — 3 parallel enemy slots (A/B/C at $DC/$E0/$D4) share tick+rearm shape driven by ZP_ADVANCE_RATE
